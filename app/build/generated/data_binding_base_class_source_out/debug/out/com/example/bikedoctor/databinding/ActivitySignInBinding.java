...
public final class ActivitySignInBinding implements ViewBinding {
  ...
  private ActivitySignInBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView13,
      @NonNull ConstraintLayout main, @NonNull TextView textView21) {
  ...
  public static ActivitySignInBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySignInBinding((ConstraintLayout) rootView, imageView13, main, textView21);
    }
